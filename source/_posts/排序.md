...
**最好情况下比较 $(n-1)$ 次，移动 $0$ 次，复杂度 $O(n)$；**
**最坏情况下比较 $\frac{n(n-1)}{2}$次，移动$\frac{(n+4)(n-1)}{2}$次，复杂度 $O(n^2)$**
**平均情况 $O(n^2)$**
...
**比较$O(n \log n)$次，移动$O(n^2)$次，时间复杂度 $O(n^2)$**
**平均情况 $O(n^2)$**
...
**最好情况下比较 $(n-1)$ 次，移动 $0$ 次，复杂度 $O(n)$；**
**最坏情况下比较 $\frac{n(n-1)}{2}$次，移动$\frac{3n(n-1)}{2}$次，复杂度 $O(n^2)$**
**平均情况 $O(n^2)$**
...
**最好情况下时间复杂度 $O(n \log n)$，空间复杂度$O(\log n)$；**
**最坏情况下时间复杂度 $O(n^2)$，空间复杂度$O(n)$；**
**平均情况下时间复杂度 $O(n \log n)$，空间复杂度$O(\log n)$**
...
**最好情况下比较 $\frac{n(n-1)}{2}$ 次，移动 $0$ 次，复杂度 $O(n^2)$；**
**最坏情况下比较 $\frac{n(n-1)}{2}$次，移动$3(n-1)$次，复杂度 $O(n^2)$**
**平均情况 $O(n^2)$**
...
**最好最坏情况下均比较 $O(n \log n)$ 次，移动 $O(n \log n)$ 次，时间复杂度 $O(n \log n)$；**
